              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildField(_prenomController, 'Prénom *', isRequired: true)),
                        const SizedBox(width: 12),
                        Expanded(child: _buildField(_nomController, 'Nom *', isRequired: true)),
                      ],
                    ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _acceptCgu ? AppColors.accent : AppColors.border,
                                width: 1.5,
                              ),
                              borderRadius: BorderRadius.circular(2),
                            ),
  ...
  Widget _buildField(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        fillColor: AppColors.white,
        contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 14),
        labelStyle: GoogleFonts.dmSans(fontSize: 13, color: AppColors.textTertiary),
      ),
      validator: validator ??
          (v) {
            if (isRequired && (v == null || v.trim().isEmpty)) return 'Champ requis';
            return null;
          },
    );
  }
